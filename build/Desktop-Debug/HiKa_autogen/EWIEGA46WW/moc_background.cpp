...
static constexpr auto qt_meta_stringdata_ZN10BackGroundE = QtMocHelpers::stringData(
    "BackGround"
);
...
Q_CONSTINIT static const uint qt_meta_data_ZN10BackGroundE[] = {
...
Q_CONSTINIT const QMetaObject BackGround::staticMetaObject = { {
    ...
    qt_meta_stringdata_ZN10BackGroundE.offsetsAndSizes,
    qt_meta_data_ZN10BackGroundE,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_tag_ZN10BackGroundE_t,
        // Q_OBJECT / Q_GADGET
...
void *BackGround::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_ZN10BackGroundE.stringdata0))
