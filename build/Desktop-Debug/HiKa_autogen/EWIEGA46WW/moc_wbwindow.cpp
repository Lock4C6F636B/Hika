...
template <> constexpr inline auto WBWindow::qt_create_metaobjectdata<qt_meta_tag_ZN8WBWindowE_t>()
{
    ...
    return QtMocHelpers::metaObjectData<WBWindow, qt_meta_tag_ZN8WBWindowE_t>(QMC::MetaObjectFlag{}, qt_stringData,
            qt_methods, qt_properties, qt_enums);
}
Q_CONSTINIT const QMetaObject WBWindow::staticMetaObject = { {
    QMetaObject::SuperData::link<OriginWindow::staticMetaObject>(),
    qt_staticMetaObjectStaticContent<qt_meta_tag_ZN8WBWindowE_t>.stringdata,
    qt_staticMetaObjectStaticContent<qt_meta_tag_ZN8WBWindowE_t>.data,
    qt_static_metacall,
    nullptr,
    qt_staticMetaObjectRelocatingContent<qt_meta_tag_ZN8WBWindowE_t>.metaTypes,
    nullptr
} };
...
void *WBWindow::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_staticMetaObjectStaticContent<qt_meta_tag_ZN8WBWindowE_t>.strings))
